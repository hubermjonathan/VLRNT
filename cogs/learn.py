...
class Learn(commands.Cog):
    ...
    async def jett(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/jett')
    ...
    async def raze(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/raze')
    ...
    async def breach(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/breach')
    ...
    async def omen(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/omen')
    ...
    async def brimstone(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/brimstone')
    ...
    async def phoenix(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/phoenix')
    ...
    async def sage(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/sage')
    ...
    async def cypher(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/cypher')
    ...
    async def reyna(self, ctx):
        ...
        embed.set_thumbnail(url='https://hubermjonathan-valorant-bot.herokuapp.com/reyna')
